	...
	<div class="container">
        <div class="content">
            <div class="disp">
                    ...
                    <ul class="recipes-ul">
                    <?php 
                    $qry = "select * from tbl_recipe where `user_id`='$user_id'"; // make select query to get all rows from recipe table
                    $sql = mysqli_query($conn,$qry) or die("error: ".$qry); // execute the query
